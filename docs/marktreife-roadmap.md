...
|---|---|---|---|---|
| P3.1 | Design-Tokens in [tailwind.config.js](../tailwind.config.js) — `theme.extend.colors.brand`, `fontFamily`, `spacing`, `borderRadius`. | **Qwen** + Designer-Mensch für Farbwahl | 0.5 d | [x] Opus · 2026-04-18 |
| P3.2 | Shared-UI-Komponenten — `<Button>`, `<Card>`, `<Skeleton>`, `<Dialog>` basierend auf `radix-ui`. | Sonnet | 2 d | [x] Opus · 2026-04-18 |
