      ...
      <div className={containerClassName}>
        ...
        <section className={dividerClassName}>
          <p className={noteClassName}>
            ...
            wesentlich ändern. Letzte Aktualisierung: {LAST_UPDATED} (Fehlerverfolgung über externen
            Dienstleister eingestellt; Abschnitt zur Fehlerüberwachung entfernt, Abschnittsnummerierung angepasst).
          </p>
        </section>
      </div>
    </>
