...
const HOTSPOT_DATA = {
  ...
  rückspülung: { title: 'Rückspülung (Regeneration)', color: '#ff7a7a', items: ['Phase 1 — Luftspülung: Pressluft löst Flocken aus dem Bett', 'Phase 2 — Wasserspülung: Wasser spült Flocken nach oben ab', 'Phase 3 — Nachspülung: klares Wasser bis Trübung < Grenzwert', 'Rückspülwasser: getrübt → Entsorgung oder Kläranlage', 'Dauer: ca. 15–30 Minuten je Zyklus', 'Protokoll: Datum, Druckverlauf, Rückspülwassermenge'] },
};
