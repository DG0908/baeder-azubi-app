...
const HOTSPOT_DATA = {
  ...
  pruefung: { title: 'Prüfpflichten & Wartung', color: '#34c090', items: ['Tägliche Sichtkontrolle vor Öffnung (Protokoll!)', 'Jährliche Hauptprüfung durch Sachverständigen', 'Prüfgrundlage: DIN EN 13451-10 (Sprunganlagen)', 'Prüfung nach Instandsetzung oder Umbau', 'Nachweis: Prüfbuch führen (Aufbewahrung 10 J)', 'Festgestellte Mängel: sofortige Sperrung bis Reparatur'] },
};
