...
const HOTSPOT_DATA = {
  ...
  filter: { title: 'Druckfilter (geschlossener Filter)', color: '#34c090', items: ['Druckbehälter aus Stahl oder GFK', 'Filtermedium: Quarzsand (0,4–0,8 mm) / Anthrazit / Aktivkohle', 'Filterschichten: von grob nach fein (unten nach oben)', 'Filtration: mechanisch + biologisch (Biofilm)', 'Druckanstieg > 0,5 bar: Rückspülung erforderlich', 'Rückspülung: Luftspülung → Wasserspülung → Normalbetrieb'] },
