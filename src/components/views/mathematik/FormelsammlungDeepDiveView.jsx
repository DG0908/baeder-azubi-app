...
const TABS = {
  grundlagen: {
    ...
    steps: [
      {
        ...
        text: 'Lies die Aufgabe genau. Was sollst du berechnen? Das ist deine gesuchte Größe. Beispiel: "Berechne das Volumen" → gesucht ist V.'
      },
      {
        title: '2. Richtige Formel finden',
        text: 'Suche in der Formelsammlung die passende Formel. Für Volumen eines Beckens brauchst du V = L × B × T. Schreib die Formel auf.'
      },
      {
        title: '3. Einheiten prüfen und umrechnen',
      ...
      },
      {
        ...
        text: 'Setze die Zahlen in die Formel ein und rechne Schritt für Schritt. Schreib die Einheit zum Ergebnis: V = 25 × 12 × 1,5 = 450 m³.'
      }
    ],
    examples: [
      {
      ...
      },
      {
        ...
        steps: [
          ['Einheiten prüfen', '180 cm = 1,8 m (erst umrechnen!)'],
          ['Formel', 'V = L × B × T'],
    ...
    pitfalls: [
      ...
      'Formel falsch umgestellt? Kontroll-Trick: Setze das Ergebnis zurück in die Originalformel ein.',
    ...
    quiz: {
      question: 'Die Formel lautet A = L × B. Ein Becken ist 50 m lang und 20 m breit. Wie gross ist die Fläche?',
  ...
  geometrie: {
    ...
    rules: [
      ...
      'Volumen Quader: V = L × B × T (Länge × Breite × Tiefe, Ergebnis in m³).',
      'Volumenstrom: Q = V ÷ t (Volumen geteilt durch Zeit, z.B. m³/h).',
      'Fliessgeschwindigkeit: vF = Q ÷ A (Volumenstrom geteilt durch Querschnittsfläche).'
    ],
    steps: [
      {
        title: '1. Form erkennen',
        text: 'Was für eine Form hat das Objekt? Rechteck → A = l × b. Kreis → A = π × r². Quader (Becken) → V = L × B × T.'
      },
      {
    ...
    examples: [
      ...
      {
        title: 'Kreisfläche eines Rundbeckens',
  ...
  physikchemie: {
    ...
    rules: [
      ...
      'Wärmemenge: Q = 1,16 × m³ × ΔT (Wh). 1,16 Wh braucht man, um 1 Liter Wasser um 1°C zu erwärmen.',
      'Chemie: Produktmenge = Aktivchlor ÷ Wirkstoffgehalt(%). Umrechnung: 1 mg/L = 1 g/m³.'
    ],
    steps: [
      {
        title: '1. Physikalische Größe identifizieren',
        text: 'Was wird gefragt? Geschwindigkeit (v), Druck (p), Arbeit (W), Leistung (P) oder Wärme (Q)? Das bestimmt die Formel.'
      },
      {
    ...
    pitfalls: [
      'Wärmeformel: Q = 1,16 × m³ × ΔT gibt Wh (Wattstunden), NICHT kWh! Durch 1.000 teilen für kWh.',
      'Chlor-Dosierung: Prozent als Dezimalzahl einsetzen! 65% = 0,65 (nicht 65).',
      'Druck: 1 bar = 100.000 Pa. Wasserdruck-Faustregel 0,1 bar/m gilt nur für Wasser, nicht für andere Flüssigkeiten.',
      'Leistung P = W ÷ t: Zeit in Sekunden einsetzen, wenn Ergebnis in Watt sein soll!'
    ],
    quiz: {
      question: 'Wie viel Wärme braucht man, um 200 m³ Wasser um 4°C zu erwärmen? (Q = 1,16 × m³ × ΔT)',
  ...
  schnellreferenz: {
    ...
    rules: [
      ...
      'Flächenmasse: 1 m² = 10.000 cm². Volumenmasse: 1 m³ = 1.000.000 cm³.'
    ],
    steps: [
      {
    ...
    examples: [
      {
        ...
        steps: [
          ...
          ['Ergebnis', '750 m³'],
          ['Check', 'm³ ist größer → Zahl wird kleiner ✓']
        ]
      },
      {
        title: 'mg/L in g/m³ umrechnen',
        given: 'Der Chlorgehalt soll 0,6 mg/L betragen. Das Becken hat 500 m³.',
        question: 'Wie viel Gramm Aktivchlor werden insgesamt benötigt?',
        steps: [
    ...
    pitfalls: [
      'Häufigster Fehler: 4,5 Stunden als "4 Stunden 50 Minuten" lesen. 0,5 h = 30 min, NICHT 50 min!',
      ...
      'mg/L und g/m³ sind GLEICH — nicht nochmal umrechnen! Das ist der häufigste Prüfungsfehler.'
    ],
    quiz: {
...
const COMMON_VALUES = [
  ...
  ['Wärme (Wasser)', '1,16 Wh pro Liter und °C'],
  ['π (Pi)', '≈ 3,14159'],
        ...
        <div className="space-y-5">
          ...
          {activeTab === 'schnellreferenz' && (
            <>
              ...
              <InfoCard darkMode={darkMode} title="Häufig gebrauchte Werte">
                <div className="overflow-hidden rounded-xl border border-transparent">
                  <table className="min-w-full text-sm">
                    <tbody>
