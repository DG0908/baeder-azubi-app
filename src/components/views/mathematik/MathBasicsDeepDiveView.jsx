...
const TOPIC_ORDER = ['grundrechenarten', 'brüche', 'dreisatz', 'prozent', 'formeln', 'pythagoras', 'flächen', 'volumen', 'zeit', 'auftrieb', 'druck', 'bewegung', 'wärme', 'mechanik', 'pumpen', 'filtration', 'chlor', 'formelsammlung'];
