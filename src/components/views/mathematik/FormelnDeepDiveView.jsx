...
const TABS = {
  grundlagen: {
    ...
    intro:
      'Eine Formel ist wie ein Rezept — sie sagt dir, wie du mit Zahlen rechnen musst, um ein Ergebnis zu bekommen. Statt Zahlen stehen in Formeln Buchstaben. Jeder Buchstabe steht fuer eine bestimmte Groesse. Zum Beispiel steht "v" fuer Geschwindigkeit und "t" fuer Zeit. Wenn du die Buchstaben durch Zahlen ersetzt, kannst du das Ergebnis ausrechnen.',
    motto: 'Buchstaben sind Platzhalter fuer Zahlen.',
    rules: [
      'Eine Formel ist eine Rechenanweisung mit Buchstaben statt Zahlen.',
      'Jeder Buchstabe steht fuer eine bestimmte Groesse (z.B. v = Geschwindigkeit, s = Strecke, t = Zeit).',
    ...
    steps: [
      {
        ...
        text: 'Schau dir die Formel an und ueberlege, wofuer jeder Buchstabe steht. Bei v = s ÷ t ist v die Geschwindigkeit, s die Strecke und t die Zeit.'
      },
      {
      ...
      },
      {
        ...
        text: 'Lies die Aufgabe und schreib auf, welche Zahlen du fuer welche Buchstaben hast. Was ist gegeben? Was wird gesucht?'
      },
      {
    ...
    examples: [
      ...
      {
        title: 'Flaechenberechnung Schwimmbecken',
      ...
      {
        title: 'Foerderstrom einer Pumpe',
        given: 'Eine Pumpe foerdert 120 m³ Wasser in 4 Stunden. Formel: Q = V ÷ t',
        question: 'Wie gross ist der Foerderstrom?',
        steps: [
          ['Formel', 'Q = V ÷ t'],
    ...
    quiz: {
      ...
      correctIndex: 1,
      explanation: 'v steht fuer Geschwindigkeit (velocity), s fuer Strecke und t fuer Zeit. Also: Geschwindigkeit = Strecke geteilt durch Zeit.'
    }
  },
  ...
  umstellen: {
    ...
    steps: [
      {
        title: '1. Gesuchte Groesse finden',
    ...
    pitfalls: [
      ...
      'Tipp: Schreib dir eine "Umstell-Tabelle" — fuer jede Formel alle drei Varianten.'
    ],
    quiz: {
  ...
  einsetzen: {
    ...
    rules: [
      ...
      'Schreib die umgestellte Formel in eine Zeile, die Zahlen in die naechste.',
      ...
      'Taschenrechner erst NACH dem Einsetzen benutzen — nicht waehrend dem Umstellen.'
    ],
    steps: [
      {
    ...
    examples: [
      ...
      },
      {
        ...
        given: 'Die Wasserflaeche ist A = 312,5 m². Die Laenge ist l = 25 m.',
      ...
      {
        title: 'Volumen berechnen bei Foerderstrom',
        given: 'Die Pumpe hat Q = 30 m³/h Foerderstrom. Sie laeuft t = 8 Stunden.',
        question: 'Wie viel Wasser wird gefoerdert?',
        steps: [
          ['Formel umstellen', 'V = Q × t'],
          ['Werte einsetzen', 'V = 30 m³/h × 8 h'],
          ['Ausrechnen', 'V = 240 m³'],
          ['Ergebnis', 'Es werden 240 m³ Wasser gefoerdert']
        ]
      }
    ],
    pitfalls: [
      'Den haeufigsten Fehler: Zahlen einsetzen BEVOR die Formel umgestellt ist — das geht fast immer schief!',
      ...
      'Ergebnis nicht pruefen — frag dich immer: Macht die Zahl Sinn?'
    ],
    quiz: {
  ...
  praxis: {
    id: 'praxis',
    chip: 'Praxis',
    title: 'Formeln im Baederalltag',
    intro:
      'Im Schwimmbad brauchst du vier Formeln staendig: Geschwindigkeit (v = s ÷ t), Foerderstrom (Q = V ÷ t), Flaeche (A = l × b) und Filtergeschwindigkeit (vF = Q ÷ A). Hier uebst du alle vier mit echten Aufgaben aus dem Badalltag. Diese Formeln kommen garantiert in der Pruefung!',
    motto: 'Vier Formeln — das ganze Bad berechnen.',
    rules: [
      'v = s ÷ t → Geschwindigkeit = Strecke geteilt durch Zeit (z.B. Wasserstroemung).',
      'Q = V ÷ t → Foerderstrom = Volumen geteilt durch Zeit (z.B. Pumpenleistung in m³/h).',
      'A = l × b → Flaeche = Laenge mal Breite (z.B. Beckenwasserflaeche).',
      'vF = Q ÷ A → Filtergeschwindigkeit = Foerderstrom geteilt durch Filterflaeche (Richtwert: ca. 30 m/h).',
      'Jede dieser Formeln kann nach jedem Buchstaben umgestellt werden — uebe alle Varianten!'
    ],
    steps: [
      {
        title: '1. Aufgabe lesen: Welche Formel?',
        text: 'Lies die Aufgabe und entscheide: Geht es um Geschwindigkeit, Foerderstrom, Flaeche oder Filtergeschwindigkeit? Das bestimmt welche Formel du brauchst.'
      },
      {
        title: '2. Formel aufschreiben und umstellen',
        text: 'Schreib die passende Formel hin. Stelle sie nach der gesuchten Groesse um. Beispiel: Foerderstrom gesucht → Q = V ÷ t.'
      },
      {
        title: '3. Werte einsetzen und ausrechnen',
        text: 'Setze die gegebenen Zahlen mit Einheiten ein und rechne aus. Vergiss nicht: Einheiten muessen zusammenpassen!'
      },
      {
        title: '4. Ergebnis pruefen',
        text: 'Pruefe: Stimmt die Einheit? Macht der Wert Sinn? Filtergeschwindigkeit sollte ca. 20-40 m/h betragen, Foerderstrom oft zwischen 20-100 m³/h.'
      }
    ],
    examples: [
      {
        title: 'Foerderstrom einer Umwaelzpumpe',
        given: 'Die Pumpe foerdert V = 480 m³ Wasser in t = 8 Stunden.',
        question: 'Wie gross ist der Foerderstrom Q?',
        steps: [
          ['Formel', 'Q = V ÷ t'],
          ['Einsetzen', 'Q = 480 m³ ÷ 8 h'],
          ['Ausrechnen', 'Q = 60 m³/h'],
          ['Ergebnis', 'Der Foerderstrom betraegt 60 m³/h']
        ]
      },
      {
        title: 'Filtergeschwindigkeit berechnen',
        given: 'Foerderstrom Q = 60 m³/h, Filterflaeche A = 2 m².',
        question: 'Wie gross ist die Filtergeschwindigkeit vF?',
        steps: [
          ['Formel', 'vF = Q ÷ A'],
          ['Einsetzen', 'vF = 60 m³/h ÷ 2 m²'],
          ['Ausrechnen', 'vF = 30 m/h'],
          ['Ergebnis', 'Die Filtergeschwindigkeit betraegt 30 m/h — im Normbereich!']
        ]
      },
      {
        title: 'Benoetigte Filterflaeche',
        given: 'Der Foerderstrom ist Q = 90 m³/h. Die Filtergeschwindigkeit soll vF = 30 m/h betragen.',
        question: 'Wie gross muss die Filterflaeche sein?',
        steps: [
          ['Formel umstellen', 'A = Q ÷ vF'],
          ['Einsetzen', 'A = 90 m³/h ÷ 30 m/h'],
          ['Ausrechnen', 'A = 3 m²'],
          ['Ergebnis', 'Die Filterflaeche muss mindestens 3 m² betragen']
        ]
      },
      {
        title: 'Umwaelzzeit eines Beckens',
        given: 'Beckenvolumen V = 450 m³, Foerderstrom Q = 75 m³/h.',
    ...
    pitfalls: [
      ...
      'Immer zuerst umstellen, dann einsetzen — auch wenn die Pruefung stresst.',
      'Richtwerte kennen: Filtergeschwindigkeit ca. 20-40 m/h, Umwaelzzeit Hallenbad ca. 4-6 h.'
    ],
    quiz: {
      question: 'Q = 80 m³/h, Filterflaeche A = 2,5 m². Wie gross ist die Filtergeschwindigkeit vF?',
...
const FORMULA_OVERVIEW = [
  ...
  ['Foerderstrom', 'Q = V ÷ t', 'm³/h', 'Pumpenleistung'],
  ['Flaeche', 'A = l × b', 'm²', 'Beckenflaeche'],
