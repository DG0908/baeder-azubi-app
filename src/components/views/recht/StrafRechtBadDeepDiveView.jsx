...
const TABS = {
  hilfeleistung: {
    ...
    intro: '§323c StGB verpflichtet JEDEN — nicht nur FaBB — bei einem Unfall oder einer Not Hilfe zu leisten, wenn dies zumutbar ist. Für Fachangestellte für Bäderbetriebe gilt eine noch strengere Sorgfaltspflicht: Als Aufsichtsperson hast du eine sogenannte Garantenstellung — du bist rechtlich verpflichtet, Gefahren zu erkennen und einzugreifen. Wer als FaBB bei einer Ertrinkung untätig bleibt, macht sich strafbar.',
    motto: 'Als FaBB bist du nicht nur moralisch — du bist RECHTLICH zur Hilfe verpflichtet.',
    rules: [
      ...
      'Zumutbarkeit: Hilfe muss ohne erhebliche eigene Gefahr möglich sein. FaBB haben Ausbildung — die Schwelle ist hoch.',
      'Garantenstellung: FaBB haben als Aufsichtspersonen eine besondere Rechtspflicht zur Gefahrenabwehr (§13 StGB).',
    ...
    steps: [
      { title: '1. Was ist §323c StGB genau?', text: '"Wer bei Unglücksfällen oder gemeiner Gefahr oder Not nicht Hilfe leistet, obwohl dies erforderlich und ihm den Umständen nach zuzumuten ist, wird mit Freiheitsstrafe bis zu einem Jahr oder mit Geldstrafe bestraft." Das gilt für jeden Bürger. Für FaBB gilt zusätzlich die Garantenstellung.' },
      { title: '2. Garantenstellung des FaBB', text: 'Durch die Berufsausübung als Aufsichtsperson übernimmt der FaBB eine Garantenstellung (§13 StGB): Er ist rechtlich verpflichtet, Schäden von Badegästen abzuwenden. Das bedeutet: Auch bloßes Nichtstun kann strafbar sein — wie aktives Handeln. Merksatz: "Wer beobachtet und nichts tut, handelt."' },
      ...
      { title: '4. Abgrenzung: wann ist Nichthelfen strafbar?', text: 'Strafbar: FaBB sitzt im Aufsichtsstand und sieht Ertrinkenden — reagiert aber nicht. Nicht strafbar: FaBB hat die Situation objektiv nicht erkannt (aber: Sorgfaltspflicht gilt!). Keine Strafbarkeit bei unzumutbarer Eigengefahr (z.B. Chlorgasunfall ohne Schutzausrüstung). Zivilrechtlich (Schadensersatz) gilt strengerer Maßstab als strafrechtlich.' },
    ],
    examples: [
      {
        title: 'Ertrinkender wird zu spät bemerkt',
        given: 'Ein FaBB schaut während der Aufsicht auf sein Handy. Ein Gast geht unter — wird nach 3 Min. mit bleibenden Hirnschäden gerettet.',
        ...
        steps: [
          ...
          ['Zivilrecht', 'Schadensersatz nach §823 BGB — Betreiber und FaBB persönlich haftbar'],
        ],
      },
    ],
    pitfalls: [
    ...
    quiz: {
      question: 'Was bedeutet die "Garantenstellung" des FaBB?',
      options: [
      ...
      correctIndex: 1,
      explanation: 'Die Garantenstellung (§13 StGB) bedeutet, dass der FaBB durch seine berufliche Position rechtlich verpflichtet ist, Schäden von Badegästen abzuwenden. Bloßes Nichtstun kann dann strafbar sein wie aktives Handeln.',
    },
  },
  ...
  fahrlassigkeit: {
    ...
    rules: [
      ...
      'Objektiver Maßstab: Wie hätte ein "gewissenhafter FaBB" in dieser Situation gehandelt?',
      'Kausalität muss vorliegen: Das Verhalten des FaBB muss ursächlich für den Schaden sein.',
    ],
    steps: [
      { title: '1. Was ist Fahrlässigkeit?', text: 'Fahrlässigkeit liegt vor wenn: (1) Eine Sorgfaltspflicht besteht (FaBB hat Aufsichtspflicht), (2) Die Sorgfaltspflicht verletzt wurde (Ablenkung, falsche Technik, Missachtung von Vorschriften), (3) Der Schaden vorhersehbar war, (4) Der Schaden durch sorgfältiges Handeln vermeidbar gewesen wäre.' },
      { title: '2. Grobe vs. einfache Fahrlässigkeit', text: 'Einfache Fahrlässigkeit: Kleines Versehen, das einem sorgfältigen FaBB passieren kann. Grobe Fahrlässigkeit: Besonders schwere Verletzung der Sorgfaltspflicht — z.B. Aufsichtsposten über längere Zeit verlassen, Rettungsgeräte nicht geprüft, offensichtliche Gefahren ignoriert. Grobe Fahrlässigkeit führt zu höherer Strafe und ist zivilrechtlich besonders bedeutsam.' },
    ...
    examples: [
      {
        ...
        steps: [
          ['Sorgfaltspflicht', 'Ja — FaBB muss nasse Bereiche sofort absichern (ASR A1.3, Rutschgefahr)'],
    ...
    pitfalls: [
      ...
      'Versicherungen des Trägers schützen den FaBB nur bedingt — bei grober Fahrlässigkeit kann Regress genommen werden.',
    ],
    quiz: {
      question: 'Was muss vorliegen damit fahrlässige Körperverletzung (§229 StGB) strafbar ist?',
      options: [
        'Der FaBB muss die Verletzung absichtlich verursacht haben',
        'Sorgfaltspflicht verletzt + Schaden vorhersehbar + Schaden vermeidbar + Kausalität',
        'Es reicht wenn der FaBB anwesend war als der Unfall passierte',
      ],
      correctIndex: 1,
  ...
  verkehrssicherung: {
    ...
    rules: [
      ...
      'Sie gilt für Betreiber UND für beauftragte Mitarbeiter — auch der FaBB kann persönlich haften.',
      'Übertragung möglich: Betreiber kann Pflichten an FaBB delegieren — Delegierender haftet bei mangelhafter Auswahl oder Einweisung.',
    ...
    steps: [
      ...
      { title: '2. Wer haftet bei einem Unfall?', text: 'Primär: Der Betreiber des Bades (Träger, Gemeinde, GmbH) — als Vertragspartner der Badegäste. Sekundär: Der FaBB persönlich, wenn er die Verkehrssicherungspflicht verletzt hat (z.B. Mängel nicht gemeldet, Aufsicht vernachlässigt). Regressanspruch: Betreiber kann Kosten bei grober Fahrlässigkeit vom FaBB zurückfordern.' },
    ...
    examples: [
      {
        ...
        steps: [
          ...
          ['Für FaBB', 'Wer den Mangel kannte und nicht handelte: persönliche Haftung möglich'],
        ],
      },
    ],
    pitfalls: [
  ...
  owis: {
    ...
    pitfalls: [
      'OWi-Bußgelder treffen oft den Betrieb — aber bei persönlichem Verstoß auch den FaBB direkt.',
