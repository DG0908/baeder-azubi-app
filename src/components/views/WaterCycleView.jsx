...
import {
  BECKEN_HOTSPOT_DATA,
  DEEP_DIVE,
  DEEP_DIVE_MODEL_HEIGHT,
  FILTER_REFERENCE_TABS,
} from './watercycle/deepDiveData';
import {
  formatCondition,
  formatLogTime,
  isConditionOk,
  ...
  PIPE_PATHS_VERTICAL,
  STATION_FOCUS_VERTICAL,
} from './watercycle/viewConfig';

const PumpDeepDiveThree = lazy(() => import('./watercycle/PumpDeepDiveThree'));
...
function DeepDiveSVG({ stationId, metrics, controls, xrayMode }) {
  ...
  if (stationId === 'pumpe') {
    return (
      <Suspense fallback={<PumpeDeepDive metrics={metrics} xrayMode={xrayMode}/>}>
        <PumpDeepDiveThree metrics={metrics} xrayMode={xrayMode}/>
      </Suspense>
    );
  }
