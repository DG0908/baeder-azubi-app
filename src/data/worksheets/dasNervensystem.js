    ...
    tasks: [
      {
        ...
        items: [
          ...
          { number: 2, accept: ['Hirnstamm', 'Stammhirn', 'Übergang zum Rückenmark', 'Uebergang zum Rueckenmark', 'Halsmark', 'Halsnerven'] },
          ...
          { number: 9, accept: ['Periphere Nerven', 'Periphere Nerv', 'Armnerv', 'Armnerven', 'Hautnerven'] },
          { number: 10, accept: ['Bauchnerven', 'Bauchnerv', 'Lendennerven', 'Rumpfnerven', 'Lumbalnerven'] },
