...
export const SAMPLE_QUESTIONS = {
  ...
  org: [
    ...
    // Marketing-Mix
    { q: 'Was beschreibt der Marketing-Mix?', a: ['Kombination der 4 Ps: Product, Price, Place, Promotion', 'Besucherströme lenken und steuern', 'Einhaltung der Hygienevorschriften nach DIN 19643', 'Personaleinsatz nach Qualifikation planen'], correct: 0 },
    // Einwintern
  ...
  tech: [
    ...
    { q: 'Was bedeutet ein hoher gebundener Chlorwert (0,5 mg/L)?', a: ['Reduktion der gelösten Stoffe', 'Zu viele Verunreinigungen, die mit Chlor reagiert haben', 'Zu wenig Badegäste', 'Optimale Desinfektion'], correct: 1 },
    ...
    // Filtersysteme
    { q: 'Was ist ein Vorteil des Schnell-Schüttfilters?', a: ['Sehr klein', 'Hohe Filterleistung bei großen Wassermengen', 'Messung des Differenzdrucks am Filter', 'Bildung einer chemischen Verbindung'], correct: 1 },
    { q: 'Was ist ein Vorteil des Anschwemmfilters?', a: ['Messung der Wasserhärte', 'Sehr feine Filtration möglich', 'Extrem billig', 'Bindung an organische Substanzen'], correct: 1 },
    { q: 'Was ist ein Vorteil des Ultrafilters?', a: ['Keine Energie nötig', 'Wartungsfrei', 'Reaktion mit Sauerstoff aus der Luft', 'Entfernt auch Bakterien und Viren'], correct: 3 },
    // Klappenstellungen
    ...
    { q: 'Wie ist das Periodensystem der Elemente aufgebaut?', a: ['Alphabetisch nach Namen', 'Nach Entdeckungsdatum', 'Abstimmung mit dem Gesundheitsamt', 'Nach steigender Ordnungszahl in Perioden und Gruppen'], correct: 3 },
    ...
    { q: 'Wobei sind Ionenbindungen typisch?', a: ['Nur bei Gasen', 'Bei Verbindungen zwischen Metallen und Nichtmetallen (z.B. NaCl)', 'Nur bei organischen Verbindungen', 'Bildung von Hydroxid-Ionen'], correct: 1 },
    { q: 'Wie unterscheidet man Ionen?', a: ['Oxidation durch Luftsauerstoff', 'Ausfällung als Calciumcarbonat', 'Kationen (positiv geladen) und Anionen (negativ geladen)', 'Erhöhung der Leitfähigkeit'], correct: 2 },
    ...
    { q: 'Was versteht man unter Dissoziation?', a: ['Neutralisation durch Säurezugabe', 'Zerfall einer Verbindung in Ionen beim Lösen in Wasser', 'Verdampfung einer Flüssigkeit', 'Gefrieren einer Lösung'], correct: 1 },
    ...
    { q: 'Wobei verwendet man die Einheit mol oder mmol?', a: ['Prüfung der Umwälzleistung', 'Bei der Angabe von Stoffmengen in der Chemie', 'Bei Temperaturmessungen', 'Bei Druckangaben'], correct: 1 },
    ...
    { q: 'Welche Bedeutung hat die Einheit ppm?', a: ['Durchführung der vorgeschriebenen Eigenkontrollen', 'Pumpenleistung pro Meter', 'Partikel pro Mikroliter', 'Parts per million = Teile pro Million = mg/L'], correct: 3 },
    ...
    { q: 'Welche Sicherheitsmaßnahmen gelten beim Umgang mit Säuren?', a: ['Überprüfung der Filtergeschwindigkeit', 'Nur Handschuhe reichen aus', 'Schutzbrille, Handschuhe, Schürze tragen; nie Wasser in Säure geben', 'Säuren können bedenkenlos mit Wasser gemischt werden'], correct: 2 },
    ...
    { q: 'Welche Sicherheitsmaßnahmen gelten beim Umgang mit Laugen?', a: ['Spülung der Filteranlage', 'Schutzbrille, Handschuhe und Schutzkleidung tragen', 'Nur bei hohen Konzentrationen vorsichtig sein', 'Laugen sind ungefährlich'], correct: 1 },
    ...
    { q: 'Was ist beim Umgang mit Säuren und Laugen allgemein zu beachten?', a: ['Schutzausrüstung tragen, getrennt lagern, nie mischen', 'Können bedenkenlos zusammen gelagert werden', 'Abspaltung von Wasserstoff', 'Nur im Freien verwenden'], correct: 0 },
    { q: 'Was tun Sie, wenn Ihre Haut mit Säure oder Lauge in Berührung kommt?', a: ['Sofort mit viel Wasser spülen (mindestens 15 Minuten)', 'Mit einem Tuch abreiben', 'Mit Seife waschen', 'Zersetzung durch UV-Strahlung'], correct: 0 },
    ...
    { q: 'Wie ist die pH-Wert-Skala aufgebaut?', a: ['Kontrolle der Dosierpumpen', 'Von 1 bis 10', 'Von -7 bis +7', 'Von 0 (stark sauer) über 7 (neutral) bis 14 (stark basisch)'], correct: 3 },
    ...
    { q: 'Was versteht man unter pH-hautneutral?', a: ['pH-Wert von ca. 5,5 (natürlicher Säureschutzmantel der Haut)', 'Kommunikation mit dem Betreiber', 'pH-Wert von 9,0', 'pH-Wert von 3,0'], correct: 0 },
    ...
    { q: 'Welche Folgen können Abweichungen des pH-Wertes im Beckenwasser haben?', a: ['Kalibrierung der Messgeräte', 'Nur optische Veränderungen', 'Verminderte Chlorwirkung, Haut-/Augenreizungen, Korrosion', 'Kontrolle der Wärmetauscher'], correct: 2 },
    ...
    { q: 'Welche Reaktion entsteht beim Mischen einer Base mit einer Säure?', a: ['Explosion', 'Überprüfung der Rohrleitungen', 'Es entsteht ein Gas', 'Neutralisation: Es entstehen Salz und Wasser'], correct: 3 },
    { q: 'Wie reagieren Säuren mit Metallen?', a: ['Überwachung der Wassertemperatur', 'Es entsteht ein Salz und Wasserstoff wird freigesetzt', 'Das Metall schmilzt', 'Es entsteht Sauerstoff'], correct: 1 },
    ...
    { q: 'Was versteht man unter Neutralisation?', a: ['Wartung der Lüftungsanlage', 'Reaktion von Säure und Base zu Salz und Wasser', 'Auflösung eines Salzes', 'Gefrieren einer Lösung'], correct: 1 },
    ...
    { q: 'Was versteht man unter Grundwasser?', a: ['Wasser in Flüssen', 'Regenwasser auf der Oberfläche', 'Unterirdisches Wasser, das durch Versickerung entsteht und in Bodenschichten gespeichert wird', 'Wartung der technischen Anlagen'], correct: 2 },
    ...
    { q: 'Wie muss Beckenwasser nach dem Bundesseuchengesetz beschaffen sein?', a: ['Trinkwasserqualität ist nicht nötig', 'Überprüfung der Pumpenkennlinie', 'Nur optisch klar', 'So beschaffen, dass eine Schädigung der Gesundheit nicht zu befürchten ist'], correct: 3 },
    { q: 'Welche Keime dürfen nicht im Beckenwasser nachweisbar sein?', a: ['Nur E. coli', 'Pseudomonas aeruginosa, E. coli, Legionellen', 'Dichtigkeitsprüfung der Leitungen', 'Nur Legionellen'], correct: 1 },
    ...
    { q: 'Was versteht man unter der Anomalie des Wassers?', a: ['Koordination mit externen Dienstleistern', 'Wasser gefriert bei -10°C', 'Wasser ist bei 0°C am dichtesten', 'Wasser hat bei 4°C seine größte Dichte und dehnt sich beim Gefrieren aus'], correct: 3 },
    { q: 'Wie wirkt sich die Anomalie des Wassers im Winter im Freibad aus?', a: ['Eis bildet sich an der Oberfläche, 4°C warmes Wasser sinkt auf den Grund', 'Das Wasser gefriert von unten nach oben', 'Das Becken platzt sofort', 'Prüfung der Notfallpläne und Rettungsketten'], correct: 0 },
    { q: 'Wann hat Wasser seine größte Dichte?', a: ['Bei 4°C', 'Bei 0°C', 'Bei 100°C', 'Bei 20°C'], correct: 0 },
    { q: 'Was versteht man unter Füllwasser?', a: ['Nur Regenwasser', 'Wasser zum erstmaligen Befüllen oder Nachfüllen des Beckens', 'Überprüfung der Wasseraufbereitungsanlage', 'Gebrauchtes Beckenwasser'], correct: 1 },
    ...
    { q: 'Was ist Reinwasser?', a: ['Rohwasser aus dem Brunnen', 'Kontrolle der Beckendurchströmung', 'Regenwasser', 'Aufbereitetes Wasser, das dem Becken zugeführt wird'], correct: 3 },
    { q: 'Was ist Filtrat?', a: ['Das Wasser, das den Filter durchlaufen hat', 'Schmutz im Filter', 'Überwachung der Öffnungszeiten', 'Rückspülwasser'], correct: 0 },
    // Schwallwasser & Messparameter (Fragen 73-81)
    { q: 'Was ist Verdrängungswasser?', a: ['Wasser aus der Filteranlage', 'Wasser in der Überlaufrinne', 'Erstellung von Gefährdungsbeurteilungen', 'Wasser, das durch den Körper des Badenden aus dem Becken verdrängt wird'], correct: 3 },
    { q: 'Was ist Schwallwasser?', a: ['Frisch zugeführtes Wasser', 'Kontrolle der Beschilderung', 'Filtrat', 'Durch Badende und Wellenbewegung über die Rinne abfließendes Wasser'], correct: 3 },
    { q: 'Warum wird Frischwasser dem Schwallwasserbehälter zugegeben?', a: ['Um den Behälter zu reinigen', 'Um die Temperatur zu senken', 'Um Wasserverluste auszugleichen und die Wasserqualität zu verbessern', 'Verwaltung der Schließfächer'], correct: 2 },
    { q: 'Was sind Messparameter/Hygienehilfsparameter?', a: ['Messwerte zur Beurteilung der Wasserqualität (pH, Chlor, Redox)', 'Nur Temperaturmessungen', 'Messungen der Wassermenge', 'Abrechnung der Tageseinnahmen'], correct: 0 },
    ...
    { q: 'Wie wirkt sich Regen auf das Wasser im Freibad aus?', a: ['Inspektion der Schwallwasserbehälter', 'Nur positiv durch Frischwasserzufuhr', 'Verdünnung, pH-Änderung, erhöhter Schmutzeintrag', 'Es wird nur wärmer'], correct: 2 },
    ...
    { q: 'Was versteht man unter einem Indikator?', a: ['Ein Stoff, der durch Farbänderung den pH-Wert oder andere Werte anzeigt', 'Ein Messgerät für Temperatur', 'Durchführung von Evakuierungsübungen', 'Eine Pumpe'], correct: 0 },
    ...
    { q: 'Was versteht man unter dem Redoxpotential des Beckenwassers?', a: ['Die Temperatur des Wassers', 'Filterbettinspektion durchführen', 'Die Wasserhärte', 'Das elektrische Potential, das die Oxidations-/Reduktionskraft des Wassers anzeigt'], correct: 3 },
    ...
    { q: 'Worüber gibt das Redoxpotential Auskunft?', a: ['Filterspülung zeitnah durchführen', 'Über den Wasserstand', 'Über den Salzgehalt', 'Über das Verhältnis von oxidierenden zu reduzierenden Stoffen im Wasser'], correct: 3 },
    ...
    { q: 'Wie wirkt sich Kalkausfällung im Duschwassererwärmer aus?', a: ['Wasserqualität regelmäßig messen', 'Der Erwärmer arbeitet besser', 'Kalkablagerungen reduzieren die Heizleistung und können zu Verstopfungen führen', 'Es entsteht mehr Warmwasser'], correct: 2 },
    { q: 'Wie wirkt sich eine höhere Beckenwassertemperatur (32°C) auf die Wasserhärte aus?', a: ['Betriebstagebuch aktualisieren', 'Kalkausfällung steigt, Karbonathärte sinkt', 'Karbonathärte steigt', 'Wasser wird weicher ohne Ausfällung'], correct: 1 },
    { q: 'Was tun Sie bei zu niedrigem Redoxpotential?', a: ['Chlordosierung erhöhen, Umwälzung und Filterung prüfen', 'Rückspülintervall anpassen', 'Wassertemperatur erhöhen', 'Badebetrieb fortsetzen'], correct: 0 },
    ...
    { q: 'In welchen Aggregatzuständen kommt Wasser im Schwimmbadbereich vor?', a: ['Gästebetreuung und Beschwerdemanagement', 'Nur als Dampf', 'Alle drei: Eis (Winter Freibad), Wasser (Becken), Dampf (Hallenbad)', 'Nur als Eis'], correct: 2 },
    { q: 'Was passiert im Hallenbad bei extrem niedrigen Außentemperaturen?', a: ['Lüftungsanlage überprüfen', 'Kondenswasser an Fenstern und Wänden (Taupunktunterschreitung)', 'Das Beckenwasser gefriert', 'Die Luftfeuchtigkeit sinkt'], correct: 1 },
    { q: 'Wer darf die mikrobiologische Wasserqualität untersuchen?', a: ['Jeder Bademeister', 'Nur der Betreiber', 'Akkreditierte Labore und das Gesundheitsamt', 'Auswertung der Besucherzahlen'], correct: 2 },
    { q: 'Welche Messmethoden gibt es für die chemische Wasserqualität?', a: ['Photometrische und kolorimetrische Verfahren, Teststreifen', 'Durchströmungsgeschwindigkeit prüfen', 'Nur optische Prüfung', 'Nur Temperaturmessung'], correct: 0 },
    { q: 'Wie können Chlorwerte des Beckenwassers ermittelt werden?', a: ['DPD-Methode (photometrisch/kolorimetrisch) oder Messautomatik', 'Hygieneparameter dokumentieren', 'Beckenwasserzirkulation optimieren', 'Beckenumgang kontrollieren'], correct: 0 },
    { q: 'Mit welchen Geräten wird der pH-Wert bestimmt?', a: ['Chlorgehalt manuell kontrollieren', 'Photometer, pH-Meter (Glaselektrode), Teststreifen, Indikatorlösung', 'Rettungsgeräte überprüfen', 'Frischwasserzufuhr regulieren'], correct: 1 },
    { q: 'Was versteht man unter dem photometrischen Messverfahren?', a: ['Bestimmung der Konzentration durch Lichtabsorption einer gefärbten Lösung', 'Messung mit Fotografien', 'Messung mit Sonnenenergie', 'Optische Schätzung der Wasserfarbe'], correct: 0 },
    { q: 'Was versteht man unter dem Siedepunkt des Wassers?', a: ['Temperatur, bei der das Wasser verdampft (100°C bei Normaldruck)', 'Temperatur, bei der das Wasser gefriert', 'Der Punkt, an dem Salz sich auflöst', 'Die maximale Wassertemperatur im Becken'], correct: 0 },
    { q: 'Was versteht man unter dem Gefrierpunkt des Wassers?', a: ['Temperatur, bei der das Wasser zu Eis wird (0°C bei Normaldruck)', 'Temperatur, bei der das Wasser verdampft', 'Temperatur des Beckenwassers im Winter', 'Die minimale Duschtemperatur'], correct: 0 },
    { q: 'Was versteht man unter dem Kondensationspunkt?', a: ['Temperatur, bei der Wasserdampf wieder zu Flüssigkeit wird', 'Temperatur, bei der das Wasser gefriert', 'Der höchste Punkt einer Wasserleitung', 'Die Temperatur in der Sauna'], correct: 0 },
    ...
    { q: 'Welche baulichen Besonderheiten haben Erlebnisbäder?', a: ['Rutschen, Wellenbecken, Strömungskanal, Whirlpools, Saunalandschaft', 'Abstimmung mit Rettungsdiensten', 'Dosieranlage nachjustieren', 'Sicherheitsunterweisung durchführen'], correct: 0 },
    { q: 'Über welche Bereiche muss ein Hallenbad mindestens verfügen?', a: ['Eingang, Umkleiden, Duschen, Schwimmhalle, Technikräume, Sanitäranlagen', 'Nur ein Becken', 'Chemikalienlager kontrollieren', 'Nur einen Eingangsbereich'], correct: 0 },
    ...
    { q: 'Bei welchen Temperaturen vermehren sich Legionellen besonders?', a: ['Zwischen 25 und 50 °C (optimal etwa 35-45 °C)', 'Unter 10 °C', 'Nur über 80 °C', 'Nur bei 0 °C'], correct: 0 },
    ...
    { q: 'Wie unterscheiden sich kolorimetrische und photometrische Wasseruntersuchungen?', a: ['Kolorimetrisch: Farbvergleich mit Auge; photometrisch: elektronische Messung der Lichtabsorption', 'Kein Unterschied', 'Kolorimetrisch ist genauer', 'Photometrisch nutzt Farbvergleichsscheiben'], correct: 0 },
    ...
    { q: 'Was versteht man unter katalytisch adsorptiver Filterwirkung?', a: ['Beschleunigte chemische Umsetzung an der Oberfläche des Filtermaterials', 'Rein mechanische Filtration', 'Thermische Wirkung', 'Elektrische Wirkung'], correct: 0 },
    ...
    { q: 'In welchen Einheiten wird die Filtergeschwindigkeit angegeben?', a: ['In m/h bzw. m³/(m²·h)', 'In U/min', 'In bar', 'In kW'], correct: 0 },
    ...
    { q: 'Welche Trennschärfe ist mit Anschwemmfiltern möglich?', a: ['Sehr feine Filtration bis in den Mikrometerbereich', 'Nur grobe Partikel über 5 mm', 'Gar keine Partikelabscheidung', 'Nur Entfärbung ohne Filtration'], correct: 0 },
