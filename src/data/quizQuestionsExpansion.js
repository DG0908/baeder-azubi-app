...
const ORG_EXPANSION_PROMPTS = [
  ...
  ['Was gehört in die Erstunterweisung neuer Mitarbeitender?', 'Notfallwege, Alarmablaeufe und Meldeketten'],
  ...
  ['Was wird bei der Kursplanung zuerst geprueft?', 'Verfügbare Wasserflaeche und qualifiziertes Personal'],
  ...
  ['Warum wird die Haus- und Badeordnung sichtbar ausgehaengt?', 'Gäste kennen Regeln schon vor der Nutzung'],
  ...
  ['Warum wird das Notfalltelefon täglich geprueft?', 'Es muss im Ernstfall sofort funktionieren'],
  ...
  ['Was ist bei Alarmuebungen entscheidend?', 'Rollen ueben, Zeiten messen, Lücken schliessen'],
  ...
  ['Warum sollte Ersatz für Rettungsgeraete verfügbar sein?', 'Ausfaelle duerfen Einsatzbereitschaft nicht stoppen'],
  ['Wozu dient eine Prioritätenliste bei Reparaturen?', 'Sicherheitskritische Maengel werden zuerst behoben'],
  ...
  ['Wofuer dient ein Gewitter-Frühwarnschema?', 'Fruehe Entscheidung zu Räumung und Sperrung'],
  ...
  ['Womit laesst sich Servicequalitaet gut messen?', 'Wartezeit, Rückmeldungen und Beschwerdequote'],
  ...
  ['Was gilt für Reinigungsarbeiten waehrend Öffnungszeiten?', 'Absichern, kennzeichnen und Wege freihalten'],
  ...
  ['Was macht die Tagesverantwortung bei ploetzlichem Wetterumschwung?', 'Betriebslage prüfen und Schutzmassnahmen ausloesen'],
  ['Warum werden Kontrollgaenge protokolliert?', 'Maßnahmen sind später nachvollziehbar'],
...
const POL_EXPANSION_PROMPTS = [
  ['Wofuer ist der Bundestag in erster Linie zuständig?', 'Gesetze beraten und beschliessen'],
  ...
  ['Welche Versicherung ist bei Arbeitsunfaellen zuständig?', 'Die gesetzliche Unfallversicherung'],
  ...
  ['Wofuer steht die Erststimme bei der Bundestagswahl?', 'Direktkandidat im Wahlkreis wählen'],
  ...
  ['Was ist ein einfaches Arbeitszeugnis?', 'Es bestätigt Art und Dauer der Taetigkeit'],
...
const AEVO_BASE_FACTS = [
  ...
  ['Welche Pflicht hat der Azubi beim Berichtsheft?', 'Den Ausbildungsnachweis sorgfaeltig und regelmaessig führen'],
  ['Welche Kernpflicht hat der Ausbilder gegenueber Azubis?', 'Fachlich anleiten, charakterlich fördern und für Sicherheit sorgen'],
  ...
  ['Wofuer muss der Azubi freigestellt werden?', 'Für Berufsschule, Prüfungen und angeordnete Ausbildungsmaßnahmen'],
  ['Wie hoch ist die regelmaessige tägliche Arbeitszeit für Jugendliche?', 'In der Regel maximal acht Stunden'],
  ...
  ['Was fördert die Leittextmethode besonders?', 'Selbststaendiges Planen, Entscheiden und Reflektieren'],
  ...
  ['Was ist bei erkennbarer Überforderung sinnvoll?', 'Lernschritte anpassen und gezielt unterstuetzen'],
  ...
  ['Was gilt bei nicht bestandener Abschlusspruefung?', 'Auf Verlangen Verlaengerung bis zur nächsten Wiederholungspruefung'],
  ['Wann ist eine Verkuerzung der Ausbildungszeit möglich?', 'Bei guten Leistungen mit begruendetem Antrag'],
  ['Ist ein digital gefuehrtes Berichtsheft zulaessig?', 'Ja, sofern die zuständigen Stellen es akzeptieren'],
