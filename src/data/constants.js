...
export const DEFAULT_MENU_ITEMS = [
  ...
  { id: 'berichtsheft', icon: '\u{1F4D6}', label: 'Berichtsheft', visible: true, order: 15, requiresPermission: null, group: 'dokumentieren' },
  { id: 'profile', icon: '\u{1F464}', label: 'Profil', visible: true, order: 16, requiresPermission: null, group: 'profil' },
